	...
	"data": [
		{
			...
			"type": "photo",
			"message": "Ich bin wütend, traurig und entsetzt! 
			WER macht so etwas in Abtenau!
			Mutwillige Zerstörung. 
			Das freiRaum Team freut sich auf sachdienliche Hinweise. Danke für die Unterstützung.",
		...
		},
		{
			...
			"type": "photo",
			"message": "Für den PILATES-Kurs am Freitag, 9:30 - 10:30 Uhr, sind noch Plätze frei! Kursstart: 4.11. (10 EH), Schnuppereinheit möglich!
			Anmeldung unter: 0680/40 120 38 oder www.balanced-body.at",
		...
		},
		{
			...
			"type": "photo",
			"message": "Kursübersicht Herbst 2016 
			Bei einigen Kursen ist es möglich noch einzusteigen!!!
			Anmeldung bitte direkt bei den Kursleiter/innen.:):):) 
			Kontakt Telefon Nr. findest du unter INFO.",
		...
		},
		{
			...
			"type": "link",
			"message": "Von 21. - 23. Oktober in Saalfeld! 
			NIA vertreten durch Sylvia Edlinger! Ein super interessantes und inspirierendes Wochenende!
			http://kongress.fitsportaustria.at/main.asp?VID=1&kat1=114&kat2=742&kat3=598",
		...
		},
		{
			...
			"type": "photo",
			"message": "So im September starten die meisten Kurse. 
			Anmeldung bei den jeweiligen Kursleiter/innen....
			Bis dann CU im freiRaum Abtenau",
		...
		{
			"type": "status",
			"message": "****ACHTUNG KURSANMELDUNGEN bodyART*****
			NEUE Handy Nr. von SONJA 0664 2190501
			*************************************************************",
		...
		{
			"type": "status",
			"message": "bei 31 Grad und gefühlte 50 auf unserer Sonnenterasse war gestern unser freiRaum Sommerfest.
			Mit musikalischen Klängen auf Gitarre, Key Board und Gesang haben wir unser Fest ausklingen lassen. 
			Wir werden uns jetzt nach und nach in die kreative Sommerpause zurückziehen!

			Danke an alle, die unseren schönen freiRaum Abtenau das ganze Jahr so toll beleben!

			2 sportliche Sommertermine die das Warten bis September verkürzen...

			Pilates Sommer Schnupperstunden
			* MI 20.7. 19:30 Uhr
			* FR 26.8. 09:30 Uhr
			Anmeldung erbeten....Durchführung ab 7 Personen gesichert!

			Herzliche Grüsse Kati 
			vom freiRaum Abtenau Team",
		...
		},
		{
			...
			"type": "photo",
			"message": "Die Trainerinnen der SU Sektion Aktivsport bei der Weiterbildung Teamgeist. Es war eine tolle Veranstaltung und sehr lehrreich...
			diverse Kurse im freiRaum werden davon mit Sicherheit in Zukunft auch davon profitieren! :) :)",
